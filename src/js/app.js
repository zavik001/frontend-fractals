if (document.getElementById('fractalForm')) {
    document.getElementById('fractalForm').addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://cuddly-oranges-attack.loca.lt/api/fractals/generate', {
                method: 'POST',
...
if (document.getElementById('analyzeButton')) {
    document.getElementById('analyzeButton').addEventListener('click', async () => {
        ...
        try {
            const response = await fetch('https://cuddly-oranges-attack.loca.lt/api/analysis/data', {
                method: 'POST',
                headers: {
